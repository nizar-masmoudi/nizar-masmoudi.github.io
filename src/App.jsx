...
function App() {
  ...
  return (
    <div className='w-screen h-screen text-white bg-noise relative p-12 flex items-center justify-center'>
      ...
      <div
        id='container'
        className='absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 md:translate-x-0 md:left-24 lg:left-44 w-5/6 h-[550px] overflow-y-scroll scrollbar-hide snap-y snap-mandatory'
      >
        <Intro id='intro' />
        <About id='about' />
        <Timeline id='story'>
